...
#define     GPIO_GET_BIT(v, i)  (v & (1U << (i)))
...
pinSetSpeed(GPIO_TypeDef *pPort, uint32_t pPin, Gpio_Out_Speed_t pOutSpeed) {
    ...
    // to set the speed of pin X to high, the value (1, 0) should be written at (2X + 1, 2X) in the OSPEEDR register    // to set the speed of pin X to very-high, the value (1, 1) should be written at (2X + 1, 2X) in the OSPEEDR register
